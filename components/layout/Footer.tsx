        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            <p className="font-display font-bold text-2xl text-white mb-3">
              Prakarnit<span className="text-cyan-400">.</span>
            </p>
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  aria-label={s.label}
                  className="p-2.5 rounded-lg bg-slate-900 hover:bg-cyan-700 text-slate-400 hover:text-white transition-all duration-200"
                >
                  {s.icon}
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-sm">
                ...
                <a href={"mailto:" + siteConfig.email} className="hover:text-cyan-300 transition-colors break-all">
                  {siteConfig.email}
                </a>
              </li>
              <li className="flex items-center gap-2 text-sm">
                <Phone size={14} className="text-cyan-300 shrink-0" />
                <a href={"tel:" + siteConfig.phone.replace(/\s/g, "")} className="hover:text-cyan-300 transition-colors">
                  {siteConfig.phone}
                </a>
              </li>
